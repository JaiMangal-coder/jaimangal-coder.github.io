...
**Solution**
Here, I just installed the package.
...
**Solution**
Here, I loaded the now installed package.
...
**Solution**
I use the help function get some documentation on the package.
...
**Solution**
A vignette is available using a specified vignette and package. 

```{r}
#| eval: false


vignette("get-started", package = "esquisse")
```
